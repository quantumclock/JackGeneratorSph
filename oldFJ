!==============================================================================
	  module parameters
             implicit none
             integer, parameter:: Np = 9   ! length of a partition
             ...
             integer, parameter:: nb_orbit =9 ! how many orbitals on the sphere ! = Np?
...
!      write(*, party2) list_domin_B
!      write(*,*) '****************'
!      write(*, party2) list_domin_F
